...
class TimeTracker:
	...
	def __init__(self, focus_duration=25, short_break=5, long_break=15, cycles_to_long_break=4, total_cycles=4, project=None, task=None, data_file="tracked_time.json", sound_file="sounds/Sound_1.wav"):
